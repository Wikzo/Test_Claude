...
android {
    namespace = "com.wikzo.todo"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.wikzo.todo"
        minSdk = 26
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    // Pairing: QR code generation (ZXing) + QR scanning (ML Kit + CameraX)
    ...
    // Confetti burst for the "list fully cleared" celebration (Phase 5 whimsy pass)
